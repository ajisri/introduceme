                            ...
                            <div key={i} className="bg-background p-6 md:p-8 flex flex-col justify-between min-h-[320px] group transition-colors hover:bg-foreground/[0.02]">
                                <div className="flex flex-col gap-4">
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <span className="font-mono text-[10px] font-bold uppercase tracking-[0.15em] text-foreground leading-tight">
                                            {item.label}
                                        </span>
                                    </div>
                                ...
                                <div className="border-t border-foreground/10 pt-6 mt-8">
                                    <p className="font-unbounded font-medium uppercase tracking-tighter leading-none text-foreground text-3xl group-hover:text-swiss-red transition-colors duration-300">
                                        {item.val}
                                    </p>
